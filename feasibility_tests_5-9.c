...
{ 
    ...
    printf("Ex-5 U=%4.2f (C1=1, C2=1, C3=2; T1=2, T2=5, T3=10; T=D): ",
		   ((1.0/2.0) + (1.0/5.0) + (2.0/10.0)));
    ...
    printf("Ex-9 U=%4.2f (C1=1, C2=2, C3=4, C4=6; T1=6, T2=8, T3=12, T4=16; T=D): ",
		   ((1.0/6.0) + (2.0/8.0) + (4.0/12.0) + (6.0/16)));
